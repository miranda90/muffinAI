...
function mfn_styles_templates() {
 	...
 	if( 'inline' == mfn_opts_get('local-styles-location') && empty( $_GET['visual'] ) ) {
 		...
 		if( is_singular() ) {
 			...
 			/*if( function_exists('is_woocommerce') && is_singular('product') && !empty($mfn_global['singular_template']) && get_post_status($mfn_global['singular_template']) == 'publish' ){
 			...
 			}else if( is_singular('portfolio') && !empty($mfn_global['singular_template']) && get_post_status($mfn_global['singular_template']) == 'publish' ){
 				$id = $mfn_global['singular_template'];
 			}else if( is_singular('post') && !empty($mfn_global['singular_template']) && get_post_status($mfn_global['singular_template']) == 'publish' ){
 				$id = $mfn_global['singular_template'];
 			}else if( get_the_ID() == get_option( 'page_for_posts' ) && !empty($mfn_global['archive_template']) && get_post_status($mfn_global['archive_template']) == 'publish' ){
 				$id = $mfn_global['archive_template'];
 			}else if( is_page() && !empty($mfn_global['archive_template']) && is_page_template('template-portfolio.php') && get_post_status($mfn_global['archive_template']) == 'publish' ){
 				$id = $mfn_global['archive_template'];
 			}*/
 			...
 			/*if( (is_post_type_archive('post') || is_home() || is_category() || is_tag()) && !empty($mfn_global['archive_template']) && get_post_status($mfn_global['archive_template']) == 'publish' ){
 				$id = $mfn_global['archive_template'];
 			}else if( function_exists('is_woocommerce') && ( is_shop() || is_product_category() || is_product_tag() ) && !empty($mfn_global['archive_template']) && get_post_status($mfn_global['archive_template']) == 'publish' ){
 				$id = $mfn_global['archive_template'];
